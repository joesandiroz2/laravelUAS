<x-dashboard.layout>
    <div class="h-full p-6">
        ...
        <form action="/dashboard/users" method="POST" enctype="multipart/form-data" class="w-96 pb-6">
            @csrf

            <div class="grid gap-4 lg:gap-6">
                <div>
                    <label for="email" class="block mb-2 text-sm text-gray-700 font-medium">Email</label>
                    <input type="text" name="email" id="email" required class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="nomor_telepon" id="nomor_telepon" required class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none">
                </div>

                <div>
                    <label for="alamat" class="block mb-2 text-sm text-gray-700 font-medium">Alamat</label>
                    <textarea name="alamat" id="alamat" required class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"></textarea>
                </div>
