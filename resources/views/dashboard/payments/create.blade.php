<x-dashboard.layout>
    <div class="h-full p-6">
        ...
        <form action="/dashboard/payments" method="POST" class="w-96 pb-6">
            @csrf

            <div class="grid gap-4 lg:gap-6">
                <div>
                    <label for="id_pesanan" class="block mb-2 text-sm text-gray-700 font-medium">ID Pesanan</label>
                    <input type="number" name="id_pesanan" id="id_pesanan" required class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none">
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="total_harga" id="total_harga" required class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none">
                </div>

                <div>
                    <label for="metode" class="block mb-2 text-sm text-gray-700 font-medium">Metode</label>
                    <input type="text" name="metode" id="metode" required class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none">
                </div>
                ...
                <div>
                    ...
                    <div class="relative" data-hs-combo-box="">
                        <div class="relative">
                            <input class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none" type="text" name="status" required data-hs-combo-box-input="">
                ...
                <div>
                    ...
                    <input type="text" name="link" id="link" required class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none">
                </div>

                <div>
                    <label for="token" class="block mb-2 text-sm text-gray-700 font-medium">Token</label>
                    <input type="text" name="token" id="token" required class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none">
                </div>

                <div>
                    <label for="midtrans_id" class="block mb-2 text-sm text-gray-700 font-medium">Midtrans ID</label>
                    <input type="text" name="midtrans_id" id="midtrans_id" required class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none">
                </div>
            </div>
            <!-- End Grid -->
